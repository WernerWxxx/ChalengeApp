...
internal class Program
{
    public static void Main(string[] args)
    {
        ...
        Console.WriteLine("5 - Nauka - Czas spędoany na nauke C# z kursu A. Kamizelich");
        ...
        while (true)
        {
            ...
            if (input == "p")
            {
                ...
                Console.WriteLine("");
                Console.WriteLine(" Dane są zapisywane w Liście w - Pamięci PC - EmployeeInMemory");
                Console.WriteLine("");
            ...
            else
            {
                ...
                Console.WriteLine("");
                Console.WriteLine(" Dane są zapisywane w Pliku grades.TXT - EmployeeInFile");
                Console.WriteLine("");
